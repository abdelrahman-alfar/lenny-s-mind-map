...
export const connections: TopicConnection[] = [
  ...
  { from: 'product-strategy', to: 'product-market-fit', strength: 2 },
  ...
  { from: 'growth-strategy', to: 'startup-growth', strength: 2 },
  { from: 'experimentation', to: 'ab-testing', strength: 3 },
  { from: 'retention', to: 'product-led-growth', strength: 2 },
  { from: 'network-effects', to: 'growth-strategy', strength: 2 },
  
  // Leadership connections
  { from: 'leadership', to: 'team-building', strength: 3 },
  { from: 'leadership', to: 'decision-making', strength: 2 },
  { from: 'entrepreneurship', to: 'venture-capital', strength: 2 },
  ...
  { from: 'career-development', to: 'mentorship', strength: 2 },
